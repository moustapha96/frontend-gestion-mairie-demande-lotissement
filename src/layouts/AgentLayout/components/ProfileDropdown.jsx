    ...
    <div className="hs-dropdown relative inline-flex">
      ...
      >
        ...
        <div className="hidden text-start lg:block">
          ...
          <p className="mt-1 text-xs font-semibold text-zinc-400">{user.roles.includes('ROLE_SUPER_ADMIN') ? 'Super Admin' : user.roles.includes("ROLE_ADMIN") ? 'Admin' : user.roles.includes("ROLE_AGENT") ? 'Agent' : 'Utilisateur'}  </p>
        </div>
      </button>
