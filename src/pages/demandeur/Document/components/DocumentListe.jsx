...
import { LuChevronLeft, LuChevronRight, LuPlusSquare } from "react-icons/lu";
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                    <div className="text-sm text-gray-700">
                        Affichage de {indexOfFirstDocument + 1} à {Math.min(indexOfLastDocument, filteredDocuments.length)} sur{" "}
