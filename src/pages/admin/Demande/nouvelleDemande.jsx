...
import { Table, Input, Card, Button, Typography, message, Form } from "antd";
...
const AdminElecteurRecherche = () => {
    ...
    const columns = [
        ...
        { title: "Inscrit fichier", dataIndex: "INSCRIT_AU_FICHIER", key: "INSCRIT_AU_FICHIER", width: 130 },
        {
            ...
            render: (_, record) => (
                <Link
                    to="/admin/electeurs/creer-demande"
                    state={{ electeur: record }}  // <-- on passe tout l'objet
    ...
    // >>> Ne pas inclure page/pageSize ici
    const buildFilters = () => {
        const payload = {};
...
export default AdminElecteurRecherche;
