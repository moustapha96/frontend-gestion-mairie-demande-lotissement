...
const AgentDemandeConfirmation = () => {
    const { id } = useParams();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(`/agent/demandes/${id}/details`);
        } catch (error) {
    ...
    return (
        <>
            <AgentBreadcrumb title="Confirmation de la demande" />
            <section>
...
export default AgentDemandeConfirmation;